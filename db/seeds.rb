...
user = User.create(password: "3213123", email: "antoshin97@gmail.com")
admin = User.create(password: "123123", email: "antoshindanil@ya.ru", type: "Admin", first_name: "Danil", last_name: "Antoshin")
